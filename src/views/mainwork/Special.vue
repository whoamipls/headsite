<template>
    <div>
        ...
        <p class="hdTitle1 hdIconRect">太阳帆板驱动机构</p>
        ...
        <p class="hdSection">此驱动组件由电机和减速器组成，具有抗高低温（温度范围-40℃—+110℃）、高效率低功耗、体积小集成度高（200x60x60mm）、质量轻（低于2.5kg）、密封度高（可抗月尘）、具备冷备份，多种模式等特点。</p>
